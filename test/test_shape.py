...
def test_rotate_I_shape():
    ...
    i_360 = rotate(i_270)
    assert i_360.units[0].row == 3
    assert i_360.units[0].col == 0
    assert i_360.units[1].row == 3
    assert i_360.units[1].col == 1
    assert i_360.units[2].row == 3
    assert i_360.units[2].col == 2
    assert i_360.units[3].row == 3
    assert i_360.units[3].col == 3
...
def test_rotate_L_shape():
    ...
    assert l_90.units[1].row == 6
    assert l_90.units[1].col == 5
    assert l_90.units[2].row == 7
    assert l_90.units[2].col == 5
    assert l_90.units[3].row == 7
    assert l_90.units[3].col == 6

    l_180 = rotate(l_90)
    assert l_180.units[0].row == 5
    assert l_180.units[0].col == 5
    assert l_180.units[1].row == 5
    assert l_180.units[1].col == 6
    assert l_180.units[2].row == 5
    assert l_180.units[2].col == 7
    assert l_180.units[3].row == 6
    assert l_180.units[3].col == 5

    l_270 = rotate(l_180)
    assert l_270.units[0].row == 5
    assert l_270.units[0].col == 6
    assert l_270.units[1].row == 5
    assert l_270.units[1].col == 7
    assert l_270.units[2].row == 6
    assert l_270.units[2].col == 7
    assert l_270.units[3].row == 7
    assert l_270.units[3].col == 7

    l_360 = rotate(l_270)
    assert l_360.units[0].row == 6
    assert l_360.units[0].col == 7
    assert l_360.units[1].row == 7
    assert l_360.units[1].col == 5
    assert l_360.units[2].row == 7
    assert l_360.units[2].col == 6
    assert l_360.units[3].row == 7
    assert l_360.units[3].col == 7
...
def test_rotate_T_shape():
    ...
    assert t_90.units[1].row == 5
    assert t_90.units[1].col == 6
    assert t_90.units[2].row == 5
    assert t_90.units[2].col == 7
    assert t_90.units[3].row == 6
    assert t_90.units[3].col == 6

    t_180 = rotate(t_90)
    assert t_180.units[0].row == 5
    assert t_180.units[0].col == 7
    assert t_180.units[1].row == 6
    assert t_180.units[1].col == 6
    assert t_180.units[2].row == 6
    assert t_180.units[2].col == 7
    assert t_180.units[3].row == 7
    assert t_180.units[3].col == 7

    t_270 = rotate(t_180)
    assert t_270.units[0].row == 6
    assert t_270.units[0].col == 6
    assert t_270.units[1].row == 7
    assert t_270.units[1].col == 5
    assert t_270.units[2].row == 7
    assert t_270.units[2].col == 6
    assert t_270.units[3].row == 7
    assert t_270.units[3].col == 7

    t_360 = rotate(t_270)
    assert t_360.units[0].row == 5
    assert t_360.units[0].col == 5
    assert t_360.units[1].row == 6
    assert t_360.units[1].col == 5
    assert t_360.units[2].row == 6
    assert t_360.units[2].col == 6
    assert t_360.units[3].row == 7
    assert t_360.units[3].col == 5
...
def test_rotate_Z_shape():
    ...
    assert z_90.units[0].col == 2
    assert z_90.units[1].row == 2
    assert z_90.units[1].col == 3
    assert z_90.units[2].row == 3
    assert z_90.units[2].col == 3
    assert z_90.units[3].row == 3
    assert z_90.units[3].col == 4

    z_180 = rotate(z_90)
    assert z_180.units[0].row == 2
    assert z_180.units[0].col == 4
    assert z_180.units[1].row == 3
    assert z_180.units[1].col == 3
    assert z_180.units[2].row == 3
    assert z_180.units[2].col == 4
    assert z_180.units[3].row == 4
    assert z_180.units[3].col == 3

    z_270 = rotate(z_180)
    assert z_270.units[0].row == 3
    assert z_270.units[0].col == 2
    assert z_270.units[1].row == 3
    assert z_270.units[1].col == 3
    assert z_270.units[2].row == 4
    assert z_270.units[2].col == 3
    assert z_270.units[3].row == 4
    assert z_270.units[3].col == 4

    z_360 = rotate(z_270)
    assert z_360.units[0].row == 2
    assert z_360.units[0].col == 3
    assert z_360.units[1].row == 3
    assert z_360.units[1].col == 2
    assert z_360.units[2].row == 3
    assert z_360.units[2].col == 3
    assert z_360.units[3].row == 4
    assert z_360.units[3].col == 2
